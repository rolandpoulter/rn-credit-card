...
const CreditCardForm = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_LibraryContext.default.Provider, {
    ...
    onFocus: () => setFocusedField(_types.CardFields.CardNumber),
    onValid: goNext,
    onChange: value => {
      if (props.onChange) {
    ...
    onFocus: () => setFocusedField(_types.CardFields.CardHolderName),
    onChange: value => {
      if (props.onChange) {
    ...
    onFocus: () => setFocusedField(_types.CardFields.CVV),
    onValid: goNext,
    onChange: value => {
      if (props.onChange) {
