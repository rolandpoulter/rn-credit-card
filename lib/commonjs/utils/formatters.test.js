...
describe('cardNumberFormatter', () => {
  test.each([{
    ...
    expect((0, _formatters.cardNumberFormatter)(oldValue, newValue)).toEqual(output);
  });
});
describe('expirationDateFormatter', () => {
  test.each([{
    ...
    expect((0, _formatters.expirationDateFormatter)(oldValue, newValue)).toEqual(output);
  });
});
